...
type MetricDefinition struct {
	...
	Conception  string `gorm:"type:varchar(512);not null" json:"display_name"`            // 概念说明
	...
	WarnupBound  *float64 `gorm:"type:double" json:"warn_upbound"`     //todo 警告/故障上界
	WarnlowBound *float64 `gorm:"type:double" json:"warn_lowbound"`    //todo 警告/故障下界
	...
	//否决
	IsVeto int `gorm:"type:int" json:"is_veto"` //todo 是否“一票否决”：1是、0否
