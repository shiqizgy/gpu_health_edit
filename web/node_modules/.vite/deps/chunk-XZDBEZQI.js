...
// node_modules/.pnpm/echarts@5.6.0/node_modules/echarts/lib/legacy/getTextRect.js
...
var Component_default2 = ComponentModel;
...
function getListCache(axis, prop) {
  return inner3(axis)[prop] || (inner3(axis)[prop] = []);
}
...
function makeAutoCategoryInterval(axis) {
  var result = inner3(axis).autoInterval;
  return result != null ? result : inner3(axis).autoInterval = axis.calculateCategoryInterval();
}
...
var SeriesModel = (
  ...
  function(_super) {
    ...
    SeriesModel2.prototype.init = function(option, parentModel, ecModel) {
      ...
      this.mergeDefaultAndTheme(option, ecModel);
      var sourceManager = inner4(this).sourceManager = new SourceManager(this);
      ...
      inner4(this).dataBeforeProcessed = data;
      autoSeriesName(this);
    ...
    SeriesModel2.prototype.mergeDefaultAndTheme = function(option, ecModel) {
      ...
      if (Component_default2.hasClass(themeSubType)) {
        themeSubType += "Series";
      }
    ...
    SeriesModel2.prototype.mergeOption = function(newSeriesOption, ecModel) {
      ...
      var sourceManager = inner4(this).sourceManager;
      sourceManager.dirty();
      sourceManager.prepareSource();
    ...
    SeriesModel2.registerClass = function(clz) {
      return Component_default2.registerClass(clz);
    };
...
mountExtend(SeriesModel, Component_default2);
...
var ChartView = (
  ...
  function() {
    ...
    ChartView2.markUpdateMethod = function(payload, methodName) {
      inner5(payload).updateMethod = methodName;
    };
...
function renderTaskReset(context) {
  ...
  var updateMethod = payload && inner5(payload).updateMethod;
...
function checkMissingComponents(option) {
  each(option, function(componentOption, mainType) {
    if (!Component_default2.hasClass(mainType)) {
  ...
  function(_super) {
    ...
    GlobalModel2.prototype._mergeOption = function(newOption, opt) {
      ...
      if (replaceMergeMainTypeMap) {
        replaceMergeMainTypeMap.each(function(val, mainTypeInReplaceMerge) {
          if (Component_default2.hasClass(mainTypeInReplaceMerge) && !newCmptTypeMap.get(mainTypeInReplaceMerge)) {
            newCmptTypes.push(mainTypeInReplaceMerge);
            newCmptTypeMap.set(mainTypeInReplaceMerge, true);
          }
        });
      }
      Component_default2.topologicalTravel(newCmptTypes, Component_default2.getAllClassMainTypes(), visitComponent, this);
      function visitComponent(mainType) {
        ...
        setComponentTypeToKeyInfo(mappingResult, mainType, Component_default2);
        ...
        each(mappingResult, function(resultItem, index) {
          ...
          if (!newCmptOption) {
            ...
            var ComponentModelClass = Component_default2.getClass(
              mainType,
    ...
    GlobalModel2.prototype.restoreData = function(payload) {
      ...
      componentsMap.each(function(components, componentType) {
        if (Component_default2.hasClass(componentType)) {
          componentTypes.push(componentType);
        }
      });
      Component_default2.topologicalTravel(componentTypes, Component_default2.getAllClassMainTypes(), function(componentType) {
...
function mergeTheme(option, theme2) {
  ...
  each(theme2, function(themeItem, name) {
    ...
    if (!Component_default2.hasClass(name)) {
...
function normalizeSetOptionInput(opts) {
  ...
  opts && each(normalizeToArray(opts.replaceMerge), function(mainType) {
    if (true) {
      assert(Component_default2.hasClass(mainType), '"' + mainType + '" is not valid component main type in "replaceMerge"');
    }
...
var dataColorPaletteTask = {
  ...
  overallReset: function(ecModel) {
    ...
    ecModel.eachSeries(function(seriesModel) {
      ...
      inner6(seriesModel).scope = colorScope;
    });
    ecModel.eachSeries(function(seriesModel) {
      ...
      var idxMap = {};
      var data = seriesModel.getData();
      var colorScope = inner6(seriesModel).scope;
      var stylePath = seriesModel.visualStyleAccessPath || "itemStyle";
      var colorKey = getDefaultColorKey(seriesModel, stylePath);
      data.each(function(idx) {
      ...
      prepareView = function(ecIns, isComponent) {
        ...
        function doPrepare(model) {
          ...
          if (!view2) {
            ...
            var Clazz = isComponent ? Component_default.getClass(classType.main, classType.sub) : (
              // FIXME:TS
...
var extensionRegisters = {
  ...
  registerSubTypeDefaulter: function(componentType, defaulter) {
    Component_default2.registerSubTypeDefaulter(componentType, defaulter);
  },
...
//# sourceMappingURL=chunk-XZDBEZQI.js.map
